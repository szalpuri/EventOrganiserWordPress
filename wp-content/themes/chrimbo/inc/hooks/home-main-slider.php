...
if ( ! function_exists( 'chrimbo_featured_home_slider' ) ) :
    ...
    function chrimbo_featured_home_slider() { 
        ...
        if( 1 != $chrimbo_customizer_all_values['chrimbo-feature-slider-enable'] )
        {
            return null;
        }
            ...
            $chrimbo_feature_enable_button = $chrimbo_customizer_all_values['chrimbo-fs-enable-button-text'];
                        ...
                        <div class="col-xs-10 col-sm-10 col-md-10 col-xs-offset-1 banner-content">
                            <div class="banner-content-holder">
                                <div class="banner-content-inner">
                                    ...
                                    <div class="btn-holder"><a href="<?php echo esc_url( $chrimbo_feature_button_url );?>" class="button"><?php echo esc_html( $chrimbo_feature_enable_button );?></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
